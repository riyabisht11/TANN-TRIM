      ...
      <main className="pt-8 px-6 md:px-12 card inline-flex flex-col space-y-12 w-full">
        ...
        <main className="space-y-7">
          {cartItems.map((item, idx) => (
            <div
              key={item.id}
              className="item flex flex-col xl:flex-row shadow-[0px_0px_15px_5px_rgba(0,_0,_0,_0.1)] p-2 md:p-3 rounded-xl relative  items-center xl:items-start"
            >
              <div>
              ...
              <div className="pr-6 space-y-6">
                <div className="font-book text-[#444C40]">
                  <h1 className="font-normal text-base">{item.name}</h1>
                ...
                <div className="flex justify-between">
                  <div className="flex space-x-3">
                    <div
                      ...
                      className="decrease rounded-full size-6 bg-[#444C40] flex justify-center items-center"
                    >
                    ...
                    <div
                      ...
                      className="increase rounded-full size-6 bg-[#444C40] flex justify-center items-center"
                    >
                      <img src={add} alt="" />
                    </div>
                  </div>
              ...
              <div
                ...
                className="rounded-full size-5 bg-[#444C40] flex justify-center items-center absolute right-1 top-1"
              >
