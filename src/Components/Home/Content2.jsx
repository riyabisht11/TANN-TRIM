  ...
  return (
    <div className='max-w-screen-2xl mx-auto px-5 md:px-16 py-14 overflow-x-hidden'>
      <div className='flex justify-between flex-col md:flex-row gap-8 md:gap-0'>
        ...
        {/* Right Video Section */}
        <div data-aos="fade-left" data-aos-duration="2000" className="right relative md:shrink-0 w-[250px] md:w-[350px] xl:w-[502px] aspect-square rounded-full overflow-hidden mx-auto md:mx-0">
