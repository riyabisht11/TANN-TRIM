        ...
        <main className="pt-8 px-6 md:px-12 card inline-flex flex-col space-y-8 lg:space-y-12 ">
          ...
          <main className="space-y-5 lg:space-y-7 flex-grow max-h-[40vh] overflow-y-auto">
            {cartItems.map((item, idx) => (
              <div className="item flex flex-col xl:flex-row border p-2 md:p-3 rounded-xl relative  items-center xl:items-start">
                <div>
                ...
                <div className="pr-6 space-y-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="relative left-16 whitespace-nowrap">
